...
transcript_febin = {'Vehicle Vibrations' : [1, 3], 'Drives and Gears' : [1.3, 3],
              ...
              'Vehicle Propulsion Systems' : [2.7, 3], 'Simulation of Bus Systems' : [2, 4], 'Electric and Hybrid vehicles' : [1.7, 3],
              'CAE in Control Engineering' : [2.3, 4], 'Seminar Electromobility' : [0,3],
